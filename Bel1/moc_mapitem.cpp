...
const QMetaObject MapItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MapItem.data,
      qt_meta_data_MapItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MapItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MapItem.stringdata0))
        return static_cast<void*>(const_cast< MapItem*>(this));
